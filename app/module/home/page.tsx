...
export function HomePage() {
	...
	return (
		<div className="relative w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
			<div className="relative w-full bg-gradient-to-b from-red-200 to-white h-[400px] sm:h-[500px] lg:h-[550px] rounded-xl">
				...
				<div className="absolute inset-0 flex items-center justify-center px-4 sm:px-6 lg:px-8">
					<div className="relative w-full max-w-2xl text-center">
						<h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-3 sm:mb-4">Temukan dan Pahami Budaya Indonesia</h1>
						<h2 className="text-base sm:text-lg lg:text-xl text-black font-bold mb-6 sm:mb-8">Cerita, tradisi, dan warisan dari Sabang sampai Merauke</h2>
						<div className="space-y-4">
							<div className="relative">
								<Input
									...
									className="py-3 sm:py-4 text-base sm:text-lg rounded-full border-2 border-white/50 bg-white/80 backdrop-blur-md text-gray-900 focus:border-white/70 focus:bg-white/90 shadow-lg"
								/>
								{searchValue === "" && (
									<div
