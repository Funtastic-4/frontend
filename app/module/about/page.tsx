...
export function AboutPage() {
	return (
		<div className="min-h-screen">
			<div className="bg-gradient-to-b from-red-200 to-white text-black py-16 mx-6 mt-6 rounded-3xl">
			...
			<div className="max-w-6xl mx-auto px-6 py-12 space-y-16">
				...
				<section className="grid lg:grid-cols-2 gap-12 items-stretch">
					...
					<div className="order-2 flex items-center">
						<div>
							<img
								src="/reog-ponorogo.jpg"
								alt="Traditional Indonesian Artisans"
								className="w-full h-auto object-cover rounded-lg shadow-md"
								style={{ maxWidth: '500px', height: 'auto' }}
							/>
							<p className="text-xs text-gray-500 mt-2">
								Source: <a href="https://toprankmedia.id/news/reog-ponorogo/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-700 underline">toprankmedia.id</a>
							</p>
						</div>
					</div>
				</section>
